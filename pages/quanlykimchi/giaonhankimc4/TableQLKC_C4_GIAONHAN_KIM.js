...
import { delete_QLKC_C4_GIAONHAN_KIM, update_kyC1_PM_QLKC_C4_GIAONHAN_KIM, update_kyC2_PM_C4_GIAONHAN_KIM, update_huyPM_QLKC_C4_GIAONHAN_KIM, update_loaiBBan_QLKC_C4_GIAONHAN_KIM } from "../../../services/quanlykimchi/QLKC_C4_GIAONHAN_KIMService";
...
const TableQLKC_C4_GIAONHAN_KIM = ({
    ...
    const confirm = async () => {
        ...
        try {
            if (isMultiDelete) {
                await Promise.all(selectedRecords.map(record => delete_QLKC_C4_GIAONHAN_KIM(record.id)));
                toast.current.show({
                    severity: "success",
                    summary: "Thông báo",
        ...
        return (
            <div className="flex">
                ...
                <Button
                    ...
                    tooltipOptions={{ position: "top" }}
                    style={{
                        backgroundColor: "#1445a7", marginRight: '10px'
                    }}
                    onClick={() => {
                        setIsHide(true);
                        setId(rowData.id);
                ...
                {rowData?.tranG_THAI === 0 && (
                    <Button
                        ...
                        onClick={async () => {
                            try {
                                await update_kyC1_PM_QLKC_C4_GIAONHAN_KIM(rowData.id);
                                toast.current.show({
                                    severity: "success",
                                    summary: "Thông báo",
                ...
                {rowData?.tranG_THAI === 1 && (
                    <Button
                        ...
                        onClick={async () => {
                            try {
                                await update_kyC2_PM_C4_GIAONHAN_KIM(rowData.id);
                                toast.current.show({
                                    severity: "success",
                                    summary: "Thông báo",
                ...
                <Button
                    ...
                    onClick={async () => {
                        try {
                            await update_huyPM_QLKC_C4_GIAONHAN_KIM(rowData.id);
                            toast.current.show({
                                severity: "success",
                                summary: "Thông báo",
                ...
                <Button
                    ...
                    onClick={async () => {
                        try {
                            await update_loaiBBan_QLKC_C4_GIAONHAN_KIM(rowData.id);
                            toast.current.show({
                                severity: "success",
                                summary: "Thông báo",
